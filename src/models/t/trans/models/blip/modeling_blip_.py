...
class BlipForQuestionAnswering(BlipPreTrainedModel):
    ...
    def forward(
        ...
        # cross_h = self.standard_cross_attention_fusion(decoder_output=mid_feature,
        #                                                encoder_output=last_hidden_state_vero,
        #                                                cross_attention_layer=self.fusion_cross_attention,
        #                                                dropout_layer=self.fusion_dropout,
        #                                                layernorm_layer=self.fusion_layernorm)
