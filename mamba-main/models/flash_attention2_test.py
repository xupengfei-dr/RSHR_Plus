...
from t.trans.modeling_flash_attention_utils import _flash_attention_forward
...
class MyFlashAttention2(MyAttention):
    ...
    def forward(
        ...
        value_states = value_states.view(bsz, q_len, self.num_key_value_heads, self.head_dim).transpose(1, 2)# 32 8 40 48
